...
def web_workload():
    return (
        ...
        "http://public.dhe.ibm.com/systems/power/docs/systemi/v6r1/en_US/sc415454.pdf",
        "http://public.dhe.ibm.com/systems/power/docs/systemi/v6r1/en_US/sc415409.pdf",
        "https://static.roland.com/assets/media/pdf/TD-27_Reference_eng01_W.pdf",
    )
